...
if __name__ == '__main__':
    ...
    information()
    experiment_name = 'DQN_ot_V2_coef_0.5'   # 'variational_autoencoder' or 'dense'
    ...
    stopping_criterion = {
        # 'time_total_s': 60 * 60 * 2,  # 20 minutes
    #     'env_runners/episode_reward_mean': 0.85,
    }
    train_batch_size = 4_000    # 4000 * 20    # 4000 * 20
    mini_batch_size = 4_000     # 2000  # 2000
    num_learners = 1
    ...
    accelerator = 'gpu'
    max_time = timedelta(hours=0, minutes=30)  # 60 minutes
